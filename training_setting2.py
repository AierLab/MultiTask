...
parser.add_argument('--training_in_path_Haze', type=str,default= '/home/4paradigm/set2/RESIZE/SOTS/outdoor/hazy/')
parser.add_argument('--training_gt_path_Haze', type=str,default= '/home/4paradigm/set2/RESIZE/SOTS/outdoor/gt/')

parser.add_argument('--training_in_pathRain', type=str,default= '/home/4paradigm/set2/rainy_image_dataset/training/rainy_image/')
parser.add_argument('--training_gt_pathRain', type=str,default= '/home/4paradigm/set2/rainy_image_dataset/training/ground_truth/')
...
parser.add_argument('--eval_in_path_Haze', type=str,default= '/home/4paradigm/set2/RESIZE/SOTS/outdoor/hazy/')
parser.add_argument('--eval_gt_path_Haze', type=str,default= '/home/4paradigm/set2/RESIZE/SOTS/outdoor/gt/')

parser.add_argument('--eval_in_path_Rain', type=str,default= '/home/4paradigm/set2/rainy_image_dataset/testing/rainy_image/')
parser.add_argument('--eval_gt_path_Rain', type=str,default= '/home/4paradigm/set2/rainy_image_dataset/testing/ground_truth/')
